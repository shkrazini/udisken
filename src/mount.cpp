...
MountPoints GetMountPoints(udisks_api::proxies::UdisksFilesystem& fs) {
...
bool NotifyMounted(udisks_api::proxies::UdisksBlock& blk,
...
auto Mount(udisks_api::proxies::UdisksFilesystem& fs)
...
auto TryAutomount(objects::BlockDevice& blk_device)
    -> std::optional<std::string> {
  udisks_api::proxies::UdisksBlock& blk{blk_device.Block()};
